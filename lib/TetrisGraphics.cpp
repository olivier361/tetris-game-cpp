...
void Graphics::TetrisGraphics::drawText(double tlx, double tly, int fontSize, double rgba[4], const char text[]) {
    glRasterPos2i(tlx, tly);
    // TODO: use proper color parameter
